...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 1210678; //Xbox prefix
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(65000000000000000); // 650 Million
...
/* Premine amount */
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(100000000000000); // 1 Million
...
*/
const char     GENESIS_COINBASE_TX_HEX[]                     = "010a01ff00018080e983b1de160250dc9530d5733df72658557d1fc2ea59ce25a0724b089a6a17afb8a77828ab312101ade85971ae5d5a671835ef17e905dc273cb23ccfd375efefd894fbc373d542a5";
static_assert(sizeof(GENESIS_COINBASE_TX_HEX)/sizeof(*GENESIS_COINBASE_TX_HEX) != 1, "GENESIS_COINBASE_TX_HEX must not be empty.");

/* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
   You can get this value by doing "print_block 2" in TurtleCoind. It is used to know what timestamp
   to import from when the block height cannot be found in the node or the node is offline. */
const uint64_t GENESIS_BLOCK_TIMESTAMP                       = 1582245236;
...
const uint32_t UPGRADE_HEIGHT_V4                             = 300000; // Upgrade height for CN-Lite Variant 1 switch.
const uint32_t UPGRADE_HEIGHT_V5                             = 400000; // Upgrade height for CN-Turtle Variant 2 switch.
...
const char     CRYPTONOTE_NAME[]                             = "BoostedPro";
...
const int      P2P_DEFAULT_PORT                              =  57577;
const int      RPC_DEFAULT_PORT                              =  57578;
...
const char     LATEST_VERSION_URL[]                          = "https://github.com/boostedpro-45/XBOX";
const std::string LICENSE_URL                                = "https://github.com/boostedpro-45/XBOX/blob/master/LICENSE";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
  {  0xbc, 0xad, 0x77, 0xf4, 0x34, 0xaa, 0xff, 0x11, 0x43, 0x32, 0x21, 0x42, 0x67, 0x99, 0xfa, 0x00  }
};

const char* const SEED_NODES[] = {
  "206.189.221.31:57577",
  "104.248.238.125:57577"
};
} // CryptoNote
